...
export const ModalProduct = () => {
  ...
  if (product) {
    ...
    orderPrice = orderProduct ? orderProduct.count * product.price : product.price;
  }
          ...
          <div className={style.container}>
              ...
              <div className={style.ingredients}>
                ...
                <ul className={style.ingredients__list}>
                  {product.ingredients.map((ingredient, i) => (
                    <li key={i} className={style.ingredients__item}>
                      {ingredient}
                    </li>
                  ))}
                </ul>
            ...
            <div className={style.footer}>
              <div className={style.add}>
                <button className={style.btn} onClick={() => dispatch(addProduct({ id: product.id }))}>
                  Добавить
                </button>
                {orderProduct && <Count count={orderProduct.count} id={id} />}
              </div>
